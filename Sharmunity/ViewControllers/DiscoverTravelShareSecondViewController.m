...
- (void)viewDidLoad {
    ...
    switch (_controllerType) {
        case DiscoverTravelPartner:
            self.navigationItem.title = @"找fei伴";
            break;
...
-(void)viewsSetup{
    ...
    [shareRentButton setTitle:@"no ticket" forState:UIControlStateNormal];
    ...
    [soloRentButton setTitle:@"has ticket" forState:UIControlStateNormal];
    ...
    departAirportView.hidden = YES;
    UILabel *departAirportTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(originX, 0, 100, 40)];
    departAirportTitleLabel.text = @"flight NO.";
